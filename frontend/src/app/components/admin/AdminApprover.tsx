...
const AdminApprover: React.FC<ReviewActionsProps> = ({ status, id }) => {
  ...
  return (
    <>
      <div className="fixed bottom-16 z-50 mx-[-1999px] flex h-28 w-[9999px] items-center justify-center self-center bg-white md:bottom-0 md:drop-shadow-2xl" />
      <div className="fixed bottom-16 left-0 z-50 flex w-full justify-start md:bottom-0">
